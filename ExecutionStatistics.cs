namespace SingleCycleMIPS
{
    public class ExecutionStatistics
    {
        ...
        public int CacheReadHit { get; set; } = 0;
        public int CacheReadColdMiss { get; set; } = 0;
        public int CacheReadConflictMiss { get; set; } = 0;
        public int CacheReadCapacityMiss { get; set; } = 0;
        public int CacheWriteAllocateMiss { get; set; } = 0;
        public int CacheWriteNoAllocateMiss { get; set; } = 0;
        public int CacheWriteHit { get; set; } = 0;
